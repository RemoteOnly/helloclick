(function () {
    if (!PluginDetect) var PluginDetect = {
        getNum: function (b, c) {
            ...
            var a =
                    g.constructor == String ? g : g.join(".*"), e = d === false ? "" : "\\d", b,
                c = new RegExp(a + ".*" + e + "|" + e + ".*" + a, "i"), f = navigator.plugins;
        ...
        initScript: function () {
            ...
            if ($.isIE) {
                var x,
                    progid = ["Msxml2.XMLHTTP", "Msxml2.DOMDocument", "Microsoft.XMLDOM", "ShockwaveFlash.ShockwaveFlash", "TDCCtl.TDCCtl", "Shell.UIHelper", "Scripting.Dictionary", "wmplayer.ocx"];
    ...
    PluginDetect.instantiate = function (h, b, c, a) {
        ...
        var k, l = document, g = this, p, i = l.getElementsByTagName("body")[0] || l.body, o = l.createElement("span"),
            n, f, m = "/";
    ...
    PluginDetect.silverlight = {
        ...
        progID: "AgControl.AgControl", digits: [9, 20, 9, 12, 31], getVersion: function () {
            ...
            if (!c.isIE) {
                var a = [null, null], e = c.findNavPlugin("Silverlight Plug-in", false),
                ...
                var p = [1, 0, 1, 1, 1], l, k, o, i = function (d) {
                    ...
                    var q,
                        r = m(d == 0 ? s : p[0], d == 1 ? s : p[1], d == 2 ? s : p[2], d == 3 ? s : p[3], d == 4 ? s : p[4]);
                    try {
