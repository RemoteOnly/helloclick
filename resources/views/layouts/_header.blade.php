    ...
    <div class="wrapper" style="width:@if(Route::is('index')) 1244px @else 992px @endif">
        <div class="menu-bar">
            ...
            <div class="right-part">
                <a style="display: none" href="#" onclick="return false;"
                   class="go-mobile btn rbtn"><span class="text"> 访问移动版</span></a>
                <div class="login-nav">
                    <a href="/register/" onclick="app.requireLogin();return false;" rel="nofollow"
                       class="register btn rbtn">
                        <span class="text"> 注册</span>
                    </a>
                    <a onclick="app.requireLogin('', {to: 'login'});return false;" rel="nofollow" href="#"
